                    ...
                    <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                        ...
                        <form action="" method="post" class="flex flex-col p-5 gap-5 text-center relative z-20">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input name="email" type="email" placeholder="Ingresa email" class="h-10 border border-zinc-300 bg-white rounded-sm px-3">
                            </div>

                            <div class="flex flex-col">
                                <span class="font-bold text-zinc-700 self-start">Contraseña</span>
                                <input name="password" type="password" placeholder="Ingresa email" class="h-10 border border-zinc-300 bg-white rounded-sm px-3">
                            </div>
