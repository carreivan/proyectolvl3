...
$sql = "SELECT  nombre, apellido, correo_electronico, direccion, fecha_nacimiento, matricula FROM usuarios WHERE user_id = '$user_id'";
...
<head>
    ...
    <title>Universidad | Alumno Profile</title>
</head>
                    ...
                    <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                        ...
                        <div class="flex flex-col p-5 gap-5 text-center relative z-20">
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="self-start"><?php echo $matricula; ?></p>
                            </div>


                            <div class="flex flex-col">
                                <span class="font-bold text-zinc-700 self-start">Email</span>
                                <p class="self-start"><?php echo $correo; ?></p>
                            </div>
                            ...
                            <div class="flex flex-col">
                                ...
                                <p class="self-start"><?php echo $fecha; ?></p>
                            </div>
