...
$sql = "SELECT  nombre, apellido, correo_electronico, contrasena, direccion, fecha_nacimiento, matricula FROM usuarios WHERE user_id = '$user_id'";
...
<head>
    ...
    <title>Universidad | Alumno Edit Profile</title>
</head>
                        ...
                        <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                            ...
                            <form action="alumno_edit_profile.php" method="post" class="flex flex-col p-5 gap-5 text-center relative z-20">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $matricula; ?>" type="text" disabled class="h-10 border border-zinc-300 bg-white rounded-sm px-3">
                                </div>
