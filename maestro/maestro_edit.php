...
<head>
    ...
    <title>Universidad | Maestro Edit Alumnos</title>
</head>
                    ...
                    <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                        ...
                        <form method="post" class="flex flex-col p-5 gap-5 text-center relative z-20">
                            ...
                            <div class="flex flex-col">
                                ...
                                <input type="text" value="<?php echo $matricula_alumno; ?>"
                                    class="h-10 border border-zinc-300 bg-white rounded-sm px-3" disabled>
                            </div>


                            <div class="flex flex-col">
                                <span class="font-bold text-zinc-700 self-start">Calificación Actual</span>
                                <input type="text" value="<?php echo $calificacion_actual; ?>"
                                    class="h-10 border border-zinc-300 bg-white rounded-sm px-3" disabled>
                            </div>

                            <div class="flex flex-col">
                                <span class="font-bold text-zinc-700 self-start">Nueva Calificación</span>
                                <input type="number" step="0.01" min="0" max="100" name="nueva_calificacion"
