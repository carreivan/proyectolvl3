...
<head>
    ...
    <title>Universidad | Maestro Edit Profile</title>
</head>
                        ...
                        <div class="w-80 h-auto bg-white rounded-sm sm:w-96">
                            ...
                            <form action="maestro_edit_profile.php" method="post"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $contrasena; ?>" name="contrasena" required type="password"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $correo; ?>" name="email" required type="email"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $nombre; ?>" name="nombre" type="text"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $apellido; ?>" name="apellido" type="text"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $direccion; ?>" name="direccion" type="text"
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <input value="<?php echo $fecha; ?>" name="fecha_nacimiento" type="date"
                                        class="h-10 border border-zinc-300 bg-white rounded-sm px-3">
                                </div>
